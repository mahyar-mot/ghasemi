...
export default function Navbar() {
    ...
    useEffect(() => {
        ...
        //     .then( res => dispatch({ type: SET_USER_PROFILE_NAME, payload: res.result }) )
        //     .catch( _ => {})
        // }
    }, [userName])
    ...
    return (
        <>
        <nav className="navbar navbar-expand-lg shadow text-center" style={{backgroundColor: "#002329"}}>
            ...
            <div className="container">
                ...
                isLoggedIn && 
                    (
                        ...
                        //     <div className="d-inline-block px-1 py-1  text-center ml-2">
                        //         <span className="font-main-color">
                        ...
                        //             {userName}        
                        //         </span>
                        //         <span className="bg-white borderSize-1 font-main-color  d-inline-block"
                        //                 style={{width: '28px', height: '28px'}}>
                        //             <FaRegUser />
                        //         </span>
                        //     </div>
                        // </Dropdown>
                        <span className="text-white pointer" onClick={() => onLogout()}>خروج</span>
                    )
                }
